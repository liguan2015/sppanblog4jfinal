...
import net.sppan.jfinalblog.JFinalBlogConfig;
...
public class _Generator {
	...
	public static DataSource getDataSource() {
		DruidPlugin druidPlugin = JFinalBlogConfig.getDruidPlugin();
		druidPlugin.start();
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "net.sppan.jfinalblog.common.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath()
				+ "/src/main/java/net/sppan/jfinalblog/common/model/base";

		System.out.println("输出路径："+ baseModelOutputDir);

		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "net.sppan.jfinalblog.common.model";
